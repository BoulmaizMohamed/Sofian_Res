  ...
  <div class="reservation-form reveal">
    <div class="form-grid">
      ...
      <div class="form-group">
        ...
        <input type="tel" class="form-input" placeholder="0555 000 000">
      </div>
      <div class="form-group">
        <label class="form-label"><i class="fa-solid fa-envelope"></i> البريد الإلكتروني</label>
        <input type="email" class="form-input" placeholder="example@email.com">
      </div>
      <div class="form-group">
        <label class="form-label"><i class="fa-solid fa-users"></i> عدد الأشخاص</label>
        <select class="form-input">
          <option value="">اختر عدد الأشخاص</option>
          <option>1 - 2 شخص</option>
          <option>3 - 5 أشخاص</option>
          <option>6 - 10 أشخاص</option>
          <option>أكثر من 10 أشخاص</option>
        </select>
      </div>
      <div class="form-group">
        <label class="form-label"><i class="fa-solid fa-calendar-plus"></i> تاريخ الوصول</label>
        <input type="date" class="form-input">
      </div>
      <div class="form-group">
        <label class="form-label"><i class="fa-solid fa-calendar-minus"></i> تاريخ المغادرة</label>
        <input type="date" class="form-input">
      </div>
      <div class="form-group full">
        <label class="form-label"><i class="fa-solid fa-house"></i> نوع الإقامة</label>
        <select class="form-input">
          <option value="">اختر نوع الإقامة</option>
          <option>غرفة مزدوجة</option>
          <option>شاليه عائلي</option>
          <option>خيمة تخييم فاخرة</option>
          <option>جناح بانوراما</option>
          <option>إقامة جماعية</option>
        </select>
      </div>
      <div class="form-group full">
        <label class="form-label"><i class="fa-solid fa-message"></i> ملاحظات إضافية</label>
        <textarea class="form-input" rows="4" placeholder="أي طلبات خاصة أو ملاحظات تودّ إخبارنا بها..."></textarea>
      </div>
    </div>
